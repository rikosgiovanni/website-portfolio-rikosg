...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class AutoDriver {
      mouse: any; manager: any; enabled: any; speed: any; resumeDelay: any; rampDurationMs: any;
...
`;
    ...
    class Advection extends ShaderPass {
      ...
      updateOverride({ dt, isBounce, BFECC }: any) {
    ...
    class ExternalForce extends ShaderPass {
      ...
      constructor(simProps: any) {
        ...
        this.initOverride(simProps);
      }
      initOverride(simProps: any) {
        super.init();
    ...
    class Viscous extends ShaderPass {
      ...
      updateOverride({ viscous, iterations, dt }: any) {
        let fbo_in, fbo_out;
    ...
    class Pressure extends ShaderPass {
      ...
      updateOverride({ vel, pressure }: any) {
        this.uniforms.velocity.value = vel.texture;
    ...
    class Simulation {
      ...
      update() {
        ...
        this.advection.updateOverride({
          dt: this.options.dt,
          isBounce: this.options.isBounce,
          BFECC: this.options.BFECC
        });
        this.externalForce.updateOverride({
          cursor_size: this.options.cursor_size,
        ...
        if (this.options.isViscous) {
          vel = this.viscous.updateOverride({
            viscous: this.options.viscous,
            iterations: this.options.iterations_viscous,
            dt: this.options.dt
          });
        }
        this.divergence.updateOverride({ vel });
        const pressure = this.poisson.updateOverride({
          iterations: this.options.iterations_poisson
        });
        this.pressure.updateOverride({ vel, pressure });
      }
    }
    ...
    class WebGLManager {
      props: any; lastUserInteraction: any; autoDriver: any; output: any; _loop: any; _resize: any; _onVisibility: any; running: any;
      constructor(props: any) {
        this.props = props;
