...
export default function DecryptedText({
  ...
  return (
    <motion.span 
      ...
      ref={containerRef} 
      style={{ ...styles.wrapper, whiteSpace: isAnimating ? 'nowrap' : 'pre-wrap' }} 
      {...animateProps} 
      {...props}
    >
        ...
        {displayText.split('').map((char, index) => {
          ...
          return (
            <span 
              ...
              style={!isRevealedOrDone ? { fontFamily: 'monospace', display: 'inline-block', width: '1ch', textAlign: 'center' } : {}}
            >
              {char}
            </span>
          );
